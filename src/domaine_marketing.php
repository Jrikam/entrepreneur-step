...
<head>
    <meta charset="UTF-8">
    <title>Domaine Marketing - Entrepreneur Step</title>
...
<div class="container">
    <h1>Marketing</h1>
    <p>Ici vos inspitrations prennent forme et trouvent leur public</p>

    form method="POST" action="enregistrer_historique.php">
    <label for="titre">Titre du projet</label>
    <input type="text" id="titre" name="titre" placeholder="Ex: Crée une campagne pour promouvoir une boutique locale" required>
